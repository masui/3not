...
d1 = {}
d1[0b01010101] = '01010101'
d1[0b00110011] = '00110011'
d1[0b00001111] = '00001111'

d1 = check(d1)

d1.keys.each { |v|
  d2 = d1.dup
  d2[v ^ 0b11111111] = "(^ #{d1[v]})"
  d2 = check(d2)
  d2.keys.each { |v|
    d3 = d2.dup
    ...
    if d3[0b10101010] && d3[0b11001100] && d3[0b11110000]
      puts "FOUND!!!!"
      puts "10101010 = #{d3[0b10101010]}"
      puts "11001100 = #{d3[0b11001100]}"
      puts "11110000 = #{d3[0b11110000]}"
      exit
    end
  }
}
